...
seo:
  ...
  description: "SKIES Mobile 0.4 is a major update with a custom color picker, iCloud sync, push notifications, app lock, redesigned settings, and unread badges."
  canonical: ""
  noindex: false
---
